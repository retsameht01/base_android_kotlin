...
import com.tinle.checkin.vm.MangeCheckinVM
import com.tinle.checkin.core.capFirstLetter
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.getCheckins().observe(this, Observer<List<CheckinViewData>>{
           if( it != null) {
            ...
            //TODO add option to set rewards points used for customer.
            //TODO Make the views more consistent
            //TODO Load all customers into local DB on launch.
